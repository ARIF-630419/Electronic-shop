        ...
        <div className="second">
          ...
          <div className="row flex">
            <div className="col__3">
              ...
              <p>
              Text messages that include discounts are the bread and butter of most SMS marketing strategies. Here’s how to write discount messages that drive more revenue.
              </p>
              </div>
            </div>
            <div className="col__3">
